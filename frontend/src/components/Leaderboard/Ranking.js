...
export const Ranking = () => {
    ...
    useMemo(() => axios.get("https://r2sus-backend.herokuapp.com/api/rank/", (req, res) => { req.header("Access-Control-Allow-Origin", "*"); }).then((res) => setData(res.data)).catch((err) => console.error(err)), [])
